...
- cc0e60c: fix: improve WebSocket lifecycle handling with `on_socket` and error callbacks
...
- 0bf99ea: fix: coerce length-1 R scalars to arrays for array-typed schemas
...
- 8abbf6a: fix handling of list types
...
- ade63a2: Strip r_type and r_attributes from record-like vector returns
